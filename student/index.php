     ...
     <header class="header white-bg">
            ...
            <div class="top-nav ">
             <ul class="nav pull-right top-menu">
                    ...
                    <li>
                      <?php
							$security->Covering("../inc-temp/profilest_menu");
							?>
                            </li>
            </ul>
            </div>
...
<div id="sidebar"  class="nav-collapse " float="right">
           <?php
							$security->Covering("../inc-temp/menu_sidest");
							?>
      </div>
          </aside>
      <!--sidebar end-->
                ...
                <div class="row">
                    ...
                    <aside class="profile-info col-lg-9">
                        ...
                        <section class="panel">
                            ...
                            <?php
							$nm=$_SESSION['student_fname'];
							$sql="SELECT * FROM `students` WHERE level='2' AND fname='".$nm."'";
						 ...
						 while($rows=mysql_fetch_assoc($result))
						   {
							...
							?>
                                ...
                                <div class="row">
                                    <div class="bio-row">
                                        <p><span>نام </span>: <?php echo $_SESSION['student_fname']; ?></p>
                                    </div>
                                    <div class="bio-row">
                                        <p><span>نام خانوادگی</span>: <?php echo $_SESSION['student_lname']; ?></p>
                                    </div>
                                    <div class="bio-row">
