               ...
               <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
						  ...
						  $sql="SELECT * FROM `courses` WHERE c_start AND c_end BETWEEN '".$date1."' AND '".$date2."'";
						...
						<td>".$rows['c_end']."</td>
                          ...
                          <a href='edit1.php?id=$rows[c_code]'><button class='btn btn-primary btn-xs'><i class='icon-pencil'></i></button></a>
                          <a href=../check/delete.php?id=$rows[c_code]><button class='btn btn-danger btn-xs'><i class='icon-trash '></i></button></a>
