                      ...
                      <!--work progress start-->
						...
						$id=$security->Check_Get($_GET['id']);
						 ...
						 while($rows=mysql_fetch_assoc($result))
						   {
							   $_SESSION['stcode']=$rows['id_student'];
						  ?>
                       <div class="col-lg-6">
                        <section class="panel">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <input type="text" class="form-control" id="inputEmail1"  name="username" value="<?php echo $security->read($rows['email']); ?>" >
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <input type="text" class="form-control" id="inputEmail1"  name="username" value="<?php echo $security->read($rows['birthday']); ?>" >
